          ...
          <li class="nav-item @if ($activePage == 'master') active @endif">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="#">Data Jenis Kost</a></li>
                <li class="nav-item"> <a class="nav-link" href="#">Data Kampus</a></li>
              </ul>
            </div>
          </li>
          @endif
          @if(Auth::User()->level == "1" || Auth::User()->level == "2" || Auth::User()->level == "3")
          <li class="nav-item @if ($activePage == 'account') active @endif">
            <a class="nav-link" data-toggle="collapse" href="#ui-account" aria-expanded="false" aria-controls="ui-account">
              <i class="icon-head menu-icon"></i>
              <span class="menu-title">Data Account</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-account">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="#">Kepala Marketing</a></li>
                <li class="nav-item"> <a class="nav-link" href="#">Sales</a></li>
                <li class="nav-item"> <a class="nav-link" href="#">Pemilik Kost</a></li>
                <li class="nav-item"> <a class="nav-link" href="#">Penyewa Kost</a></li>
              </ul>
            </div>
          </li>
          @endif
          <li class="nav-item @if ($activePage == 'dataset') active @endif">
      ...
      @yield('content')
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © Me Kost <?php echo date('Y'); ?>. All rights reserved.</span>
